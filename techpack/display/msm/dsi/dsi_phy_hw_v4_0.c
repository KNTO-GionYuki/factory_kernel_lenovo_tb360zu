			    ...
			    struct dsi_phy_cfg *cfg)
{
	...
	if (phy->version == DSI_PHY_VERSION_4_2) {
		...
		/*linden code for JLINDEN-395 by yangjinmin at 20221128 start*/
		vreg_ctrl_0 = less_than_1500_mhz ? 0x52 : 0x52;
		/*linden code for JLINDEN-395 by yangjinmin at 20221128 end*/
		glbl_rescode_top_ctrl = less_than_1500_mhz ? 0x3d : 0x00;
		glbl_rescode_bot_ctrl = less_than_1500_mhz ? 0x39 : 0x3c;
		/*linden code for JLINDEN-395 by yangjinmin at 20221128 start*/
		glbl_str_swi_cal_sel_ctrl = 0x01;
		glbl_hstx_str_ctrl_0 = 0xcb;
		/*linden code for JLINDEN-395 by yangjinmin at 20221128 end*/
	} else {
