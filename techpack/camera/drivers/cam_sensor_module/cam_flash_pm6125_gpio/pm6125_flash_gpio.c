    ...
    case PM6125_FLASH_GPIO_STATE_ACTIVE:
        switch (opcode)
        {
            case CAMERA_SENSOR_FLASH_OP_FIRELOW:
                rear_current = (flash_current > FLASH_FIRE_LOW_MAXCURRENT?FLASH_FIRE_LOW_MAXCURRENT:flash_current);
                pstate.duty_cycle = PM6125_PWM_PERIOD * rear_current / FLASH_FIRE_LOW_MAXCURRENT;
                break;
            case CAMERA_SENSOR_FLASH_OP_FIREHIGH:
                rear_current = (flash_current > FLASH_FIRE_HIGH_MAXCURRENT?FLASH_FIRE_HIGH_MAXCURRENT:flash_current);
                pstate.duty_cycle = PM6125_PWM_PERIOD * rear_current / FLASH_FIRE_HIGH_MAXCURRENT;
                break;
            default:
...
MODULE_AUTHOR("zhuguangfeng <zhuguangfeng@huaqin.com>");
