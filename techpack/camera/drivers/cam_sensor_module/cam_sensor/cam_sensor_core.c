	...
	struct cam_sensor_ctrl_t *s_ctrl)
{
	...
	memcpy(s_ctrl->sensordata->sensor_name, probe_info->sensor_name, MAX_SENSOR_NAME_SIZE);
	s_ctrl->sensordata->sensor_name[MAX_SENSOR_NAME_SIZE - 1] = '\0';
	...
	void *arg)
{
	...
	case CAM_SENSOR_PROBE_CMD: {
		...
		if (strcmp(s_ctrl->sensordata->sensor_name, "ofilm_s5k4h7_main") == 0) {
			hq_register_hw_info(HWID_MAIN_CAM, "ofilm_s5k4h7_rear_i");
		} else if (strcmp(s_ctrl->sensordata->sensor_name, "qtech_gc08a3_main") == 0) {
			hq_register_hw_info(HWID_MAIN_CAM, "qtech_gc08a3_rear_ii");
		} else if (strcmp(s_ctrl->sensordata->sensor_name, "AX6595_txd_hi1339_main") == 0) {
			hq_register_hw_info(HWID_MAIN_CAM, "txd_hi1339_rear_i");
		} else if (strcmp(s_ctrl->sensordata->sensor_name, "AX6595_ofilm_ov13b10_main") == 0) {
			hq_register_hw_info(HWID_MAIN_CAM, "ofilm_ov13b10_rear_ii");
		} else if (strcmp(s_ctrl->sensordata->sensor_name, "AX6595_lce_sc800cs_front") == 0) {
			hq_register_hw_info(HWID_FRONT_CAM, "lce_sc800cs_front_i");
		} else if (strcmp(s_ctrl->sensordata->sensor_name, "AX6595_qtech_s5k4h7_front") == 0) {
			hq_register_hw_info(HWID_FRONT_CAM, "qtech_s5k4h7_front_ii");
		} else {
			CAM_ERR(CAM_SENSOR, "sensor name is not support");
		}
#endif
		CAM_INFO(CAM_SENSOR,
			...
			s_ctrl->soc_info.index,
			s_ctrl->sensordata->slave_info.sensor_slave_addr,
			s_ctrl->sensordata->slave_info.sensor_id, s_ctrl->sensordata->sensor_name);
